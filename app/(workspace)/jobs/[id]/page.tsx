  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 sm:py-12 lg:px-12 lg:py-14">
      ...
      <header className="border-b border-border pb-8">
        <div className="mb-5 flex flex-wrap items-center gap-2"><Badge variant="outline">Inbox</Badge><Badge variant="signal"><ShieldCheck /> Source preserved</Badge></div>
      ...
      <div className="grid gap-6 pt-8 lg:grid-cols-[minmax(0,1fr)_260px]">
        <Card>
          <CardHeader className="border-b border-border pb-6"><div className="flex items-center justify-between gap-4"><CardTitle>Original job description</CardTitle><span className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted-foreground">Immutable v1</span></div></CardHeader>
        ...
        <aside className="space-y-4">
          <Card className="gap-4 bg-primary text-primary-foreground">
            <CardHeader><span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-primary-foreground/55">Next step</span><CardTitle className="leading-5">Build your evidence bank</CardTitle></CardHeader>
